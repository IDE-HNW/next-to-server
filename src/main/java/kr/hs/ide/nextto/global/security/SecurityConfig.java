package kr.hs.ide.nextto.global.security;
...
import kr.hs.ide.nextto.global.jwt.filter.JwtFilter;
...
public class SecurityConfig {
    ...
    public ReactiveUserDetailsService userDetailsService(MemberRepository memberRepository) {
        return username -> Mono.fromCallable(() -> memberRepository.findById(Long.parseLong(username))
